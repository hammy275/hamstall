...
class File:
    def internalName(program): #Get name of program as it's stored
...
def Install(program):
    program_internal_name = File.internalName(program)
...
if args.install != None:
    ...
    if does_tar_exist == False:
        ...
        sys.exit()
    program_internal_name = File.internalName(to_install) #Get the internal name (trim off everything except the file name before the .tar.gz
