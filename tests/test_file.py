...
def test_exists():
    assert file.exists("./file.py") == True
    assert file.exists("./file.no") == False
...
def test_check_line():
    ...
    assert file.check_line("Verbose=False", "~/.hamstall/config", "fuzzy") == True
    assert file.check_line("ThisShouldNotBeFound=True", "~/.hamstall/config", "fuzzy") == False
...
def test_remove_line():
    ...
    assert file.check_line("Verbose=False", "~/.hamstall/config", "fuzzy") == False
...
def test_char_check():
    assert file.char_check("asdf") == False
    assert file.char_check("asdf ") == True
    assert file.char_check("as#df") == True
